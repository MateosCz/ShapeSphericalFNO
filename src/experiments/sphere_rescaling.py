...
if __name__ == "__main__":
    ...
    in_grid_L = 12
    sphere_data_generator_XT = S2ManifoldDataGenerator(seed=get_random_int())

    xT = sphere_data_generator_XT.generate_data(in_grid_L, 1)
    print(xT.shape)
    sphere_data_generator_X0 = S2ManifoldDataGenerator(radius=0.7, seed=get_random_int())
    ...
    if not draw_unconditional:
        model = CTShapeSFNO(x_feature_dim=3, l_list=(12, 6), lift_dim=8, latent_feature_dims=(8, 8), sampling="mw", activation="gelu")
        ...
        x0 = sphere_data_generator_X0.generate_data(12, 5)
        xT = sphere_data_generator_XT.generate_data(12, 1)   
